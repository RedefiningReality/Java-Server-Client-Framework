...
public class PropertiesDialog extends UserInputDialog {
	...
	public PropertiesDialog(AlertDialog dialog, String key, String defaultValue, boolean verbose, int messageLevel) {
	...
	public String start() {
		try {
			...
			if (result == null) {
				logger.printMessage("Failed to receive value from user.", WARNING);
				return null;
			}
			...
			logger.printMessage(
					"line 108: Failed to associate with properties file: " + ex.getMessage() + ": Terminating...",
					ERROR);
		}
