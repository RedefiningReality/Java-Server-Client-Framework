...
public class NumericInputDialog<T extends Number> extends TextInputDialog {
	...
	public NumericInputDialog(String title, String headerText, String contentText, boolean verbose, int messageLevel) {
		super(title, headerText, contentText);
		logger = new Logger("NumericInputDialog", verbose, messageLevel);
	}

	public NumericInputDialog(String title, String headerText, String contentText, String promptText, boolean verbose,
			int messageLevel) {
		super(title, headerText, contentText, promptText);
		logger = new Logger("NumericInputDialog", verbose, messageLevel);
	}
	...
	public String start() {
		...
		do {
			...
			if (!result.isPresent()) {
				logger.printMessage("Failed to receive numeric input from user.", WARNING);
				return null;
			}
