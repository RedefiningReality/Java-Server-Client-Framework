...
public class SocketChannelWriter {
	...
	public SocketChannelWriter(SocketChannel socketChannel, SelectionKey selectionKey, int capacity, boolean verbose,
			int messageLevel) {
		this.socketChannel = socketChannel;
		this.selectionKey = selectionKey;
	...
	private void writeFromBuffer() throws IOException {
		...
		try {
			...
			logger.printMessage(
					"line 239: Failed to write message to server: IOException: " + ex.getMessage() + ": Terminating...",
					ERROR);
