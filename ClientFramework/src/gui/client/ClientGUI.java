...
public class ClientGUI extends Application {
	...
	public static void initialize(boolean createPropertiesFile, boolean verbose, int messageLevel) throws IOException {
	...
	public static void initialize(String propFileName, String defaultHostName, int defaultPort) throws IOException {
		logger = new Logger("ClientGUI");
	...
	public static void initialize(String propFileName, String propFileLocation, String defaultHostName, int defaultPort)
			throws IOException {
		logger = new Logger("ClientGUI");
	...
	public static void initialize(String defaultHostName, int defaultPort, boolean verbose, int messageLevel)
			throws IOException {
	...
	public static void initialize(String propFileName, String defaultHostName, int defaultPort, boolean verbose,
	...
	public static void run() throws IOException {
		...
		logger.printMessage("Saving current properties to .properties file if .properties " + "file exists...", INFO);
	...
	private static void initializePropertiesFile(String propFileName, String propFileLocation) throws IOException {
		if (!PropertiesFile.isInitialized())
